...
public class PythonService extends Service implements Runnable {
    ...
    /** Same as ServiceInfo.FOREGROUND_SERVICE_TYPE_DATA_SYNC (API 34); literal avoids android.jar API 33 gaps. */
    private static final int FOREGROUND_SERVICE_TYPE_DATA_SYNC = 1 << 2;
    ...
    protected void doStartForeground(Bundle extras) {
        ...
        if (contentTitle == null || contentTitle.isEmpty()) {
            contentTitle = serviceTitle != null ? serviceTitle : "Background service";
        }
        if (contentText == null) {
            contentText = "";
        }
	...
	if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
	    // This constructor is deprecated
            ...
            // Importance is immutable for an existing channel id, so we use v2.
            String NOTIFICATION_CHANNEL_ID = "org.kivy.p4a" + getServiceId() + ".v2";
        ...
        if (Build.VERSION.SDK_INT >= 34) {
            startForeground(getServiceId(), notification, FOREGROUND_SERVICE_TYPE_DATA_SYNC);
        } else {
