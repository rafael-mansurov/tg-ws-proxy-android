...
/**
 * WebView bootstrap activity — patched for TG WS Proxy:
 * keep Android splash visible (SplashScreen API) until the real app URL loads,
 * instead of showing presplash + intermediate WebView loader frames.
 */
public class PythonActivity extends Activity {
    ...
    /** While true, system/compat splash stays on screen (Android 12+ / AndroidX). */
    private static final AtomicBoolean splashKeepOn = new AtomicBoolean(true);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        splashKeepOn.set(true);
        resourceManager = new ResourceManager(this);
        SplashScreen.installSplashScreen(this).setKeepOnScreenCondition(() -> splashKeepOn.get());
        super.onCreate(savedInstanceState);

        this.mActivity = this;
        /* No showLoadingScreen(): avoid extra presplash frame; splash overlay stays until 127.0.0.1 loads. */
